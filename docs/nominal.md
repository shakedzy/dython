...
#### `conditional_entropy(x, y, nan_strategy=REPLACE, nan_replace_value=DEFAULT_REPLACE_VALUE, base=None)`
...
- **`base`** : `float` 
    ...
    The base to use for the logarithm in conditional entropy calculations. Must be positive.
